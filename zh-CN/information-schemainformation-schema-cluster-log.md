...
aliases:
  - '/docs-cn/dev/system-tables/system-table-cluster-log/'
  - '/docs-cn/dev/reference/system-databases/cluster-log/'
  - '/zh/tidb/dev/system-table-cluster-log/'
  - '/docs-cn/dev/information-schema/information-schema-cluster-log/'
---
