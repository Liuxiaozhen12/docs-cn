...
aliases:
  - '/docs-cn/dev/system-tables/system-table-cluster-systeminfo/'
  - '/docs-cn/dev/reference/system-databases/cluster-systeminfo/'
  - '/zh/tidb/dev/system-table-cluster-systeminfo/'
  - '/dev/information-schema/information-schema-cluster-systeminfo/'
---
