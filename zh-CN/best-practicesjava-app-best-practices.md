...
aliases:
  - '/docs-cn/dev/best-practices/java-app-best-practices/'
  - '/docs-cn/dev/reference/best-practices/java-app/'
  - '/docs-cn/dev/reference/best-practices/using-tidb-in-java/'
---
