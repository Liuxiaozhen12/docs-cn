...
aliases:
  - '/docs-cn/dev/system-tables/system-table-inspection-summary/'
  - '/docs-cn/dev/reference/system-databases/inspection-summary/'
  - '/zh/tidb/dev/system-table-inspection-summary/'
---
