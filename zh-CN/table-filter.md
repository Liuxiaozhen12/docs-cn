...
aliases:
  - '/docs-cn/dev/table-filter/'
  - '/docs-cn/dev/tidb-lightning/tidb-lightning-table-filter/'
  - '/docs-cn/dev/reference/tools/tidb-lightning/table-filter/'
  - '/zh/tidb/dev/tidb-lightning-table-filter/'
---
