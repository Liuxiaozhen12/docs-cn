...
aliases:
  - '/docs-cn/dev/production-offline-deployment-using-tiup/'
  - '/zh/tidb/dev/production-offline-deployment-using-tiup'
  - '/docs-cn/dev/production-deployment-using-tiup/'
  - '/docs-cn/dev/how-to/deploy/orchestrated/tiup/'
  - '/docs-cn/dev/tiflash/deploy-tiflash/'
  - '/docs-cn/dev/reference/tiflash/deploy/'
---
