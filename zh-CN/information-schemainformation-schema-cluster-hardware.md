...
aliases:
  - '/docs-cn/dev/system-tables/system-table-cluster-hardware/'
  - '/docs-cn/dev/reference/system-databases/cluster-hardware/'
  - '/zh/tidb/dev/system-table-cluster-hardware/'
---
