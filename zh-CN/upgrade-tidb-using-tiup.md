...
aliases:
  - '/docs-cn/dev/upgrade-tidb-using-tiup/'
  - '/docs-cn/dev/how-to/upgrade/using-tiup/'
  - '/docs-cn/dev/upgrade-tidb-using-tiup-offline/'
  - '/zh/tidb/dev/upgrade-tidb-using-tiup-offline'
---
