...
title: PD 重要监控指标详解
aliases:
  - '/docs-cn/dev/grafana-pd-dashboard/'
  - '/docs-cn/dev/reference/key-monitoring-metrics/pd-dashboard/'
---
...
- Current peer count：当前集群 peer 的总量 ![PD Dashboard - Header](/media/pd-dashboard-header-v4.png)
...
- Label distribution：集群中 TiKV 节点的 label 分布情况 ![PD Dashboard - Cluster metrics](/media/pd-dashboard-cluster-v4.png)
