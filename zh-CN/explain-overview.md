...
aliases:
  - '/docs-cn/dev/query-execution-plan/'
  - '/docs-cn/dev/reference/performance/understanding-the-query-execution-plan/'
  - '/docs-cn/dev/index-merge/'
  - '/docs-cn/dev/reference/performance/index-merge/'
  - '/zh/tidb/dev/query-execution-plan/'
---
