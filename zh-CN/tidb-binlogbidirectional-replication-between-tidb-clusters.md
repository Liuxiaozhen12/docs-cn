...
title: 集群间双向同步
aliases:
  - '/docs-cn/dev/tidb-binlog/bidirectional-replication-between-tidb-clusters/'
  - '/docs-cn/dev/reference/tidb-binlog/bidirectional-replication/'
  - '/docs-cn/dev/reference/tidb-binlog/bi-repl/'
---
