...
aliases:
  - '/docs-cn/dev/system-tables/system-table-cluster-config/'
  - '/docs-cn/dev/reference/system-databases/cluster-config/'
  - '/zh/tidb/dev/system-table-cluster-config/'
  - '/docs-cn/dev/information-schema/information-schema-cluster-config/'
---
